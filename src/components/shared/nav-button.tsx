...
const colorClasses = {
  ...
  teal: {
    ...
    inactive:
      'border-teal-600 text-teal-700 hover:bg-teal-50 hover:text-teal-800 dark:border-teal-500 dark:text-teal-400 dark:hover:bg-teal-950 dark:hover:text-teal-300',
  },
};
